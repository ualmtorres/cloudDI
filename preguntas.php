...
$preguntas[1] = array(
							...
							'preguntas' => array(
									...
									6 => array (
										...
										'respuesta' => 'En <a href = "http://edx.di.ual.es">http://edx.di.ual.es</a> encontrarás cursos on-line que te '.
...
$preguntas[2] = array(
							...
							'preguntas' => array(
									...
									5 => array (
										...
										'respuesta' => 'Envía un email a <a href="mailto:diosdado@ual.es">diosdado@ual.es</a>, <a href="mailto:isalinas@ual.es">isalinas@ual.es</a> ' .
																	'o <a href="mailto:jmembriv@ual.es">jmembriv@ual.es</a> solicitando que restablezcan tu contraseña'),
									6 => array (
							...
							'preguntas' => array(
									...
									11 => array (
										...
										'respuesta' => 'La IP fija es la IP que OpenStack ha reservado a una instancia en el momento de su creación. ' .
																	...
																	'Para más información, consulta en <a href = "http://edx.di.ual.es">http://edx.di.ual.es</a> el curso '.
...
$preguntas[4] = array(
							...
							'preguntas' => array(
									...
									6 => array (
										...
										'respuesta' => 'Sí, en <a href = "http://edx.di.ual.es">http://edx.di.ual.es</a> encontrarás el curso on-line sobre servicios ' .
